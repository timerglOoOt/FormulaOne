...
class RacerModel {
    ...
    func setUp() {
        ...
        let racer1 = RacerInfo(position: "", country: UIImage(named: Countries.Netherlands)!, name: "Макс Ферстаппен (RED)", points: 255, racerInfo: """
...
""", racerImage: RacerImage.ver)
        let racer2 = RacerInfo(position: "", country: UIImage(named: Countries.Mexico)!, name: "Серхио Перес (RED)", points: 156, racerInfo: """
...
""", racerImage: RacerImage.per)
        let racer3 = RacerInfo(position: "", country: UIImage(named: Countries.Spain)!, name: "Фернандо Алонсо (AST)", points: 137, racerInfo: """
...
""", racerImage: RacerImage.alo)
        let racer4 = RacerInfo(position: "", country: UIImage(named: Countries.Britain)!, name: "Льюис Хэмилтон (MER)", points: 121, racerInfo: """
...
""", racerImage: RacerImage.ham)
        let racer5 = RacerInfo(position: "", country: UIImage(named: Countries.Spain)!, name: "Карлос Сайнс-младший (FER)", points: 83, racerInfo: """
...
""", racerImage: RacerImage.sai)
        let racer7 = RacerInfo(position: "", country: UIImage(named: Countries.Britain)!, name: "Джордж Расселл (MER)", points: 82, racerInfo: """
...
""", racerImage: RacerImage.rus)
        let racer6 = RacerInfo(position: "", country: UIImage(named: Countries.Monaco)!, name: "Шарль Леклер (FER)", points: 74, racerInfo: """
...
""", racerImage: RacerImage.lec)
        let racer8 = RacerInfo(position: "", country: UIImage(named: Countries.Canada)!, name: "Лэнс Стролл (AST)", points: 44, racerInfo: """
...
""", racerImage: RacerImage.str)
        let racer9 = RacerInfo(position: "", country: UIImage(named: Countries.France)!, name: "Эстебан Окон (ALP)", points: 31, racerInfo: """
...
""", racerImage: RacerImage.oco)
        let racer11 = RacerInfo(position: "", country: UIImage(named: Countries.France)!, name: "Пьер Гасли (ALP)", points: 16, racerInfo: """
...
""", racerImage: RacerImage.gas)
        let racer10 = RacerInfo(position: "", country: UIImage(named: Countries.Britain)!, name: "Ландо Норрис (MCL)", points: 42, racerInfo: """
...
""", racerImage: RacerImage.nor)
        let racer12 = RacerInfo(position: "", country: UIImage(named: Countries.Germany)!, name: "Нико Хюлькенберг (HAA)", points: 9, racerInfo: """
...
""", racerImage: RacerImage.hul)
        let racer13 = RacerInfo(position: "", country: UIImage(named: Countries.Thailand)!, name: "Александр Элбон (WIL)", points: 11, racerInfo: """
...
""", racerImage: RacerImage.alb)
        let racer14 = RacerInfo(position: "", country: UIImage(named: Countries.Australia)!, name: "Оскар Пиастри (MCL)", points: 17, racerInfo: """
...
""", racerImage: RacerImage.pia)
        let racer15 = RacerInfo(position: "", country: UIImage(named: Countries.Finland)!, name: "Валттери Боттас (ALF)", points: 5, racerInfo: """
...
""", racerImage: RacerImage.bot)
        let racer16 = RacerInfo(position: "", country: UIImage(named: Countries.China)!, name: "Гуаньюй Чжоу (ALF)", points: 4, racerInfo: """
...
""", racerImage: RacerImage.zho)
        let racer17 = RacerInfo(position: "", country: UIImage(named: Countries.Japan)!, name: "Юки Цунода (ALT)", points: 2, racerInfo: """
...
""", racerImage: RacerImage.tsu)
        let racer18 = RacerInfo(position: "", country: UIImage(named: Countries.Denmark)!, name: "Кевин Магнуссен (HAA)", points: 2, racerInfo: """
...
""", racerImage: RacerImage.mag)
        let racer19 = RacerInfo(position: "", country: UIImage(named: Countries.Netherlands)!, name: "Ник де Врис (ALT)", points: 0, racerInfo: """
...
""", racerImage: RacerImage.vri)
        let racer20 = RacerInfo(position: "", country: UIImage(named: Countries.USA)!, name: "Логан Сарджент (WIL)", points: 0, racerInfo: """
...
""", racerImage: RacerImage.sar)
        ...
        var finallRacerArray = [Racer]()
        
        finallRacerArray.append(Racer(position: "", country: UIImage(named: Countries.Austria)!, name: "", points: 0))
        ...
        let team1 = Racer(position: "", country: UIImage(named: Countries.Austria)!, name: "Ред Булл", points: 411)
        let team2 = Racer(position: "", country: UIImage(named: Countries.Germany)!, name: "Мерседес", points: 203)
        let team3 = Racer(position: "", country: UIImage(named: Countries.Britain)!, name: "Астон Мартин", points: 181)
        let team4 = Racer(position: "", country: UIImage(named: Countries.Italy)!, name: "Феррари", points: 157)
        let team5 = Racer(position: "", country: UIImage(named: Countries.France)!, name: "Альпин", points: 47)
        let team6 = Racer(position: "", country: UIImage(named: Countries.Britain)!, name: "Макларен", points: 59)
        let team7 = Racer(position: "", country: UIImage(named: Countries.USA)!, name: "Хаас", points: 11)
        let team8 = Racer(position: "", country: UIImage(named: Countries.Switzerland)!, name: "Альфа Ромео", points: 9)
        let team9 = Racer(position: "", country: UIImage(named: Countries.Britain)!, name: "Уильямс", points: 11)
        let team10 = Racer(position: "", country: UIImage(named: Countries.Italy)!, name: "АльфаТаури", points: 2)
        
        // Добавляем команды
        
        var teamArray = [Racer] ()
        var finallTeamArray = [Racer] ()
        
        finallTeamArray.append(Racer(position: "", country: UIImage(named: Countries.Austria)!, name: "", points: 0))
        ...
        finallTeamArray += teamArray.sorted { (lhs, rhs) -> Bool in
            return lhs.points > rhs.points }
        finallRacerArray += racerArray.sorted { (lhs, rhs) -> Bool in
            return lhs.points > rhs.points }
        
        racers.append(finallRacerArray)
        racers.append(finallTeamArray)
    }
}
